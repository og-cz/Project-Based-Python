...
My repository to the "Project Based Python" In this comprehensive program, we will take you on a journey from a novice to a proficient Python programmer by engaging in a series of 25-30 exciting projects. These projects are carefully designed to cover various levels of difficulty and encompass a wide range of applications to ensure a comprehensive

### My Own Take On This

My challenge underneath is to perfectly practice SOLID principles, write clean and maintainable code designs, and rely on minimal frameworks focusing instead on pure, clean algorithms whenever possible

#### Level I: Beginner Projects

- Simple, small tasks that build core Python basics and confidence

#### Level II: Intermediate Projects

- Practical, slightly complex problems that require modules, better logic, and cleaner design

#### Level III: Advanced Projects

- Heavy, challenging projects involving advanced concepts, larger codebases, and sophisticated algorithms
